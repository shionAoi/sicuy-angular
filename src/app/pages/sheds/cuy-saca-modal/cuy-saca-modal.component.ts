...
@Component({
    selector: 'app-cuy-saca-modal',
    templateUrl: './cuy-saca-modal.component.html',
    styleUrls: ['./cuy-saca-modal.component.css']
})
export class CuySacaModalComponent implements OnInit, OnDestroy {

    cuySacaF = new FormGroup({
    ...
    get shedAC(): AbstractControl {
        return this.cuySacaF.get('shed')
    }

    get earringAC(): AbstractControl {
        return this.cuySacaF.get('earring')
    }

    get userAC(): AbstractControl {
        return this.cuySacaF.get('user')
    }

    get documentAC(): AbstractControl {
        return this.cuySacaF.get('document')
    }

    get deathDateAC(): AbstractControl {
        return this.cuySacaF.get('deathDate')
    }

    get reasonAC(): AbstractControl {
        return this.cuySacaF.get('reason')
    }
    ...
    saveDeath() {
        this.loading = true
        this.error = null
        console.log('form', this.cuySacaF.value)
        this.cuysService.registerCuySaca(this.cuy._id, this.file, {
